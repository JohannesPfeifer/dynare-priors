...
\begin{definition}
  ...
  \[
    f(x)=C(\alpha,\beta)^{-1} \times x^{\alpha-1}e^{-\frac{x}{\beta}}
  \]
  where $C(\alpha, \beta) = \Gamma(\alpha)\beta^{\alpha}$ is the constant of
  integration.
\end{definition}
 ...
 \begin{proof}[Proof of proposition \ref{GammaDistributionMoments}]
   ...
   \[
     \begin{split}
       \mu &= C(\alpha,\beta)^{-1}\int_{0}^{\infty}x^{\alpha}e^{-\frac{x}{\beta}}\mathrm d x \\
       &= C(\alpha,\beta)^{-1}C(1+\alpha,\beta) \\
   ...
   \[
     \begin{split}
       \mathbb E [X^2] &= C(\alpha,\beta)^{-1}\int_{0}^{\infty}x^{\alpha+1}e^{-\frac{x}{\beta}}\mathrm d x \\
       &= C(\alpha,\beta)^{-1}C(2+\alpha,\beta) \\
